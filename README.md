...
- **六种镜像方向**：左对称、右对称、上对称、下对称、左上对称（副对角线斜切）、右下对称（主对角线斜切）
...
| `tests/mirror-harness.html` | 静态图镜像算法断言：六方向尺寸 / 水平垂直对称性 / 对角线斜切对称（主/副对角线）/ 斜切无透明 / 镜像块位置 / keepOriginalSize 等比缩放 / maxEdge 导出上限 / 背景色填充 / 方向区分等 51 项 |
